...
import gdown  # 👈 buat download dari Google Drive

# Pastikan model.pkl tersedia
MODEL_PATH = "model.pkl"
DRIVE_URL = "https://drive.google.com/uc?export=download&id=1oV228kVDiGSAKVHt9OnutG_FCxmc3oQA"
